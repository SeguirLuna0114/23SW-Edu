...
#plt.plot(PM10_year.columns, 'r', marker='o', label='PM10')
PM10_selected = PM10_year[['count', 'mean', 'std', 'min', 'max']]
PM10_selected.plot(kind='line', rot=0, use_index=True, grid=True, table=False)
