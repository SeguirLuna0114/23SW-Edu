...
def getArpltInfoData(pageNo, numOfRows):
    # pageNo와 numOfRows, sidoName을 매개변수로 받음
    end_point = 'https://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getCtprvnRltmMesureDnsty'
    ...
    parameters += '&sidoName=%EC%A0%84%EA%B5%AD' #시도 이름(전국, 서울, 부산, 대구, 인천, 광주, 대전, 울산, 경기, 강원, 충북, 충남, 전북, 전남, 경북, 경남, 제주, 세종)
...
while(True):
    ...
    savedFilename = 'xx_AirpltInfo.json'  # 저장할 파일 명 설정
